...
def get_images(root_path):
    train_images = glob.glob(f"{root_path}/input/training/train/images/*")
    train_images.sort()
    train_masks = glob.glob(f"{root_path}//input/training/train/masks/*")
    train_masks.sort()
    valid_images = glob.glob(f"{root_path}//input/training/valid/images/*")
    valid_images.sort()
    valid_masks = glob.glob(f"{root_path}//input/training/valid/masks/*")
    valid_masks.sort()
